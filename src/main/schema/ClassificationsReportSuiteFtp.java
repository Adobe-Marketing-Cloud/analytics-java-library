...
/**
 * <p>Java class for classifications_report_suite_ftp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="classifications_report_suite_ftp">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ftp" type="{http://marketing.adobe.com/analytics/2015/04/16}classifications_ftp" maxOccurs="unbounded"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "classifications_report_suite_ftp", propOrder = {

})
public class ClassificationsReportSuiteFtp {
    ...
    @XmlElement(required = true)
    protected List<ClassificationsFtp> ftp;
     ...
     * {@link ClassificationsFtp }
     * 
     * 
     */
    public List<ClassificationsFtp> getFtp() {
        if (ftp == null) {
            ftp = new ArrayList<ClassificationsFtp>();
        }
        return this.ftp;
    }
